---
title: "İlişkilerde Aynı Şeyleri Neden Tekrarlıyoruz?"
seo_title: "İlişkilerde Neden Aynı Şeyleri Yaşarız?"
description: "Neden hep benzer insanlara çekiliyor, neden aynı kırılmaları yaşıyoruz? Bu döngü nereden geliyor, nasıl fark edilir?"
...
excerpt_text: "Kişiler değişir, hikâye benzer kalır. Şema kimyası, döngüyü sürdüren baş etme biçimleri ve fark etmenin neye alan açtığı üzerine."
summary: "Farklı insanlarla benzer kırılmaları yaşamak yaygın bir deneyimdir. Bu yazıda ilişki örüntülerimizin nereden geldiğini, şema terapinin 'şema kimyası' dediği çekim gücünü, ilişkilerde en sık görülen şemaları, döngüyü sürdüren baş etme biçimlerini ve bu örüntüyü fark etmenin neye alan açtığını ele alıyorum."
faq:
  - q: "Neden hep benzer insanlarla ilişki kuruyorum?"
    a: "Şema terapi buna 'şema kimyası' der: en yoğun çekimi, çoğu zaman temel şemalarımızı tetikleyen kişilere karşı duyarız. Tanıdık olan tahmin edilebilir olduğu için bir tür güvenlik hissi verir. Bu farkında olmadan işleyen bir eğilimdir; yanlış karar vermekle ya da 'kötü seçim yapmakla' ilgili değildir."
  - q: "Bana iyi davranan biriyle neden ilgi duymuyorum?"
    a: "Bu yaygın bir deneyimdir. Şema tetiklenmediğinde ortaya çıkan yoğun çekim de eksik kalabilir; ilişki 'düz' ya da hatta boğucu hissedilebilir. Zamanla, yeterince kimyanın olduğu ama ihtiyaçlarınızın da görülebildiği ilişkileri tanıyabilmek üzerine çalışılır."
  - q: "İlişki örüntülerimi değiştirmek için çift terapisi mi gerekir?"
    a: "Her zaman değil. Kişinin kendi örüntüleriyle çalıştığı bireysel bir süreç de anlamlı bir zemin sunar. İhtiyacın hangi çalışma biçimine daha uygun olduğu ilk görüşmelerde birlikte değerlendirilir."
  - q: "Örüntüyü fark etmek yeterli olur mu?"
    a: "Fark etmek önemli bir başlangıçtır ama tek başına yeterli olmayabilir. Çoğu kişi 'anlıyorum ama hâlâ aynı şeyi yapıyorum' der. Bu yüzden örüntünün altındaki ihtiyacı tanımak ve yeni tepki biçimlerini güvenli bir alanda deneyebilmek de sürecin parçasıdır."
  - q: "Bu örüntüler için partnerimi mi suçlamalıyım?"
    a: "Amaç kimin haklı olduğunu bulmak değil. Örüntüler karşılıklı işler: bizim tepkimiz karşımızdakinin tepkisini, onun tepkisi de bizimkini besleyebilir. Çalışmanın odağı, bu döngüde bizim payımıza düşen kısmı fark edip esnetebilmektir."
---
...
Bu deneyimlerden kendimize ve başkalarına dair sessiz sonuçlar çıkarırız: "İhtiyaçlarımı söylersem yük olurum." "Yakınlaşırsam terk edilirim." "Güçlü görünmezsem değer görmem." Şema terapi bu sessiz sonuçlara şema der ve yetişkin ilişkilerinde nasıl devrede kaldığına bakar. Çerçevenin tamamını [şema terapi yazısında]({{ '/sema-terapi-nedir/' | relative_url }}) anlatıyorum.
...
Süreç kendi hızınızda ilerler. Nasıl çalıştığımı [Yaklaşım bölümünde]({{ '/#yaklasim' | relative_url }}), hangi konularda çalıştığımı ise [Çalışma Alanları'nda]({{ '/#alanlar' | relative_url }}) bulabilirsiniz. İlişkilerde tekrarlayan örüntülere sık eşlik eden kaygıyı [kaygı yazısında]({{ '/kaygi-neden-tekrar-eder/' | relative_url }}) ele alıyorum.

## Kaynaklar

- Young, J. E., Klosko, J. S. & Weishaar, M. E. (2003). *Schema Therapy: A Practitioner's Guide*. Guilford Press.
- Farrell, J. M., Reiss, N. & Shaw, I. A. *The Schema Therapy Clinician's Guide*. Wiley-Blackwell.
