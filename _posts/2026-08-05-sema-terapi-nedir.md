...
faq:
  - q: "Şema terapi ile bilişsel davranışçı terapi arasındaki fark nedir?"
    a: "Bilişsel davranışçı terapi ağırlıklı olarak güncel düşünce ve davranışlara odaklanır. Şema terapi ise bu düşüncelerin altındaki, çocuklukta biçimlenmiş ve yaşam boyu tekrar eden daha derin örüntüleri de kapsar. Duygusal deneyime, yaşam öyküsüne ve terapi ilişkisinin kendisine ayrıca alan açar; bilişsel tekniklerin yanında imgeleme gibi yaşantısal yöntemleri de kullanır."
  - q: "Kaç tane şema var?"
    a: "Şema terapi modelinde beş şema alanı altında toplanan 18 erken dönem uyum bozucu şema tanımlanmıştır. Bu liste araştırma ve klinik deneyime göre zaman içinde gözden geçirilmiştir; kesin ve değişmez bir sınıflandırma olarak değil, anlamayı kolaylaştıran bir çerçeve olarak düşünmek daha doğrudur."
  - q: "Şema terapi ne kadar sürer?"
    a: "Kişiye ve çalışılan konuya göre değişir. Uzun süredir devam eden, tekrar eden örüntülerle çalışıldığı için genellikle kısa süreli yaklaşımlardan daha uzun bir süreçtir. Ne kadar süreceği ilk görüşmelerdeki değerlendirmeyle birlikte netleşir."
  - q: "Şemalar tamamen ortadan kalkar mı?"
    a: "Şema terapide amaç şemaları yok etmek değil, iyileştirmektir. Bu; şemanın tetiklenme sıklığının ve şiddetinin azalması, tetiklendiğinde daha kısa sürmesi ve kişinin buna daha esnek yollarla karşılık verebilmesi anlamına gelir."
