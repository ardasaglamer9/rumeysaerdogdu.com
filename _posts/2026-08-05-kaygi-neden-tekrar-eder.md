---
title: "Kaygı Neden Tekrar Eder? Altında Yatan Kalıplar"
seo_title: "Kaygı Neden Tekrar Eder?"
description: "Kaygı neden geçmiyor, neden hep aynı konularda tekrar ediyor? Kaçınmanın rolünü ve daha rahat bir ilişki kurmayı anlatıyorum."
...
faq:
  - q: "Kaygı ile stres arasındaki fark nedir?"
    a: "Stres genellikle belirli bir dış duruma verilen tepkidir ve durum geçtiğinde azalır. Kaygı ise net bir tehdit olmasa da sürebilir; gelecekle ilgili beklentiler ve olasılıklar üzerinden kendini besleyebilir. Kaygının belirli temalarda tekrar etmesi, altında daha eski bir hassasiyetin bulunabileceğini düşündürür."
  - q: "Kaygı tamamen geçer mi?"
    a: "Kaygı insan deneyiminin doğal bir parçası olduğu için tamamen ortadan kalkması beklenen bir şey değildir. Çalışmanın amacı kaygıyı yok etmek değil; günlük hayatı daraltan yoğunluğunu azaltmak ve kaygıyla daha esnek bir ilişki kurabilmektir."
  - q: "Kaçınmak neden kaygıyı artırıyor?"
    a: "Kaçınma kısa vadede rahatlatır, ancak zihne 'burası gerçekten tehlikeliydi, iyi ki uzaklaştım' bilgisini verir. Böylece kaygı yatışmak yerine kendini doğrulamış olur. Ayrıca kaçınılan durumun aslında yönetilebilir olduğuna dair yeni bir deneyim edinme fırsatı da ortadan kalkar."
  - q: "Kaygı için ne zaman uzmana başvurmalıyım?"
    a: "Kaygı gündelik işleyişinizi, uykunuzu, ilişkilerinizi ya da çalışma düzeninizi etkilemeye başladığında bir ruh sağlığı uzmanına başvurmak iyi gelir. Bunun için belirtilerin çok şiddetli olmasını beklemek gerekmez."
  - q: "Kaygı için ilaç kullanmam gerekir mi?"
    a: "Bu değerlendirme bir psikiyatristin alanına girer; ilaç kararı hekim tarafından verilir. Psikoterapi ve ilaç tedavisi bazı durumlarda birlikte de yürütülebilir. Gerektiğinde iş birliği yapılabilecek bir psikiyatriste yönlendirme yapılabilir."
---
...
Psikoterapide kaygıyla çalışırken hem güncel döngülere hem de bu döngülerin nereden geldiğine birlikte bakarız. Şema terapinin genel çerçevesini [şema terapi yazısında]({{ '/sema-terapi-nedir/' | relative_url }}), ilişkilerde tekrar eden örüntüleri ise [ilişki yazısında]({{ '/iliskilerde-tekrarlayan-oruntuler/' | relative_url }}) anlatıyorum. Çalıştığım konuları [Çalışma Alanları bölümünde]({{ '/#alanlar' | relative_url }}) görebilirsiniz.
